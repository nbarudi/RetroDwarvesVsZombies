...
public class BecomeAlchemist extends ItemModule {
	...
	public void onInteracted(Action action, ItemStack item, Player player, PlayerInteractEvent event) {
		...
		if(!item.equals(RDvZ.is.becomeAlchemist))
			return;
	...
	public void runAbility(Player player) {
		...
		player.sendMessage("§aYou have become an Alchemist!");
	}
